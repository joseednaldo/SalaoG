       ...
       public string conec = "Database=salao_sergio;Data Source=salao_sergio.mysql.dbaas.com.br; User Id=salao_sergio; Password=m01102011;pooling=FALSE";
        ...
        public void FecharCon()
        {
            ...
            catch (System.Exception ex)
            {
                ...
                Toast.MakeText(Application.Context, "Erro ao fechar com o banco" + ex, ToastLength.Long).Show();
            }
        }
        ...
        public void Abrircon()
        {
            ...
            catch (System.Exception ex)
            {
                ...
                Toast.MakeText(Application.Context, "Erro ao conectar com o banco" + ex, ToastLength.Long).Show();
            }
        }
